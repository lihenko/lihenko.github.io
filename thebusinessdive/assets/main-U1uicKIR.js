...
for (let i2 = 0; i2 < dropdownToggles.length; i2++) {
  dropdownToggles[i2].addEventListener("click", function() {
    let toggle = this;
...
for (let i2 = 0; i2 < menuLinks.length; i2++) {
  menuLinks[i2].addEventListener("click", function() {
